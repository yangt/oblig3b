...
;;; Del av innlevering 3b i INF2810, vår 2013.
;; 
...
;; Eksempel på omdefinering av syntaksen for definisjoner 
;; slik at vi kan skrive f.eks: (square := (lambda (x) (* x x)))
;
;(define (definition? exp)
;  (if (pair? exp)
;      (if (eq? (cadr exp) ':=)
...
;; Søker gjennom listene av varibel-bindinger i første ramme og 
...
;; Vi initialiserer den globale omgivelsen i start-repl, 
;; se kommentar på slutten av fila.
